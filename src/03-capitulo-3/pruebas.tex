...
\item En Android: modificar el gesto para eliminar un servicio. No es con \comillas{swipe} sino manteniendo apretada la opción (este fue el inconveniente principal por el cual el puntaje resultó un poco más bajo en la tarea 17).

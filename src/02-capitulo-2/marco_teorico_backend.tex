...
\begin{itemize}
\item Integrar información útil para el estudiante entre los distintos sistemas implementados en la \unlp{}.
\item Proveer de nuevas operaciones, disponibles para el uso externo, de estos sistemas.
\item Comunicar los dispositivos móviles con el backend.
\end{itemize}

En las siguientes secciones analizaremos las características técnicas requeridas por las necesidades anteriormente mencionadas, que justifiquen las decisiones para este desarrollo (en relación con el \eng{backend}).

...
Sus servicios permiten especificar un documento WSDL (en formato \gls{XML}) utilizado para detallar la interfaz de conexión, brindando información al usuario sobre los parámetros y sus tipos de dato.

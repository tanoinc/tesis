...
Por todas estas razones se elige a \textit{Lumen} como \gls{framework} de desarrollo para el proyecto \comillas{Mi Universidad}. La versión que se utiliza es la 5.4.

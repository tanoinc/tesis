...
Por estas razones y su amplio uso en aplicaciones Web (manejando solicitudes \gls{http}) lo convierten en una alternativa útil para la implementación de una \gls{api} \gls{restful}. Además, se elige este lenguaje por mi experiencia en su uso.
...
Lumen es un \gls{microframework} ultra rápido que deriva de Laravel. Está orientado al desarrollo de \glspl{api} \gls{restful}.

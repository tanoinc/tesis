...
\item Menor \eng{performance}: debido a que corren dentro de un contenedor lo que produce tiempos extra de parseo, interpretación y ejecución de los scripts en \gls{javascript}.
\end{itemize}

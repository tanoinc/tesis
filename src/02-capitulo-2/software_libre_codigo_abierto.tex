...
Los beneficios estos ambos principios\cite{noyes2010openSourceGood} son:
\begin{itemize}
...
\item Libertad: La utilización de software de \textit{código abierto} libera el hecho de \comillas{estar atado} a una tecnología propietaria.
